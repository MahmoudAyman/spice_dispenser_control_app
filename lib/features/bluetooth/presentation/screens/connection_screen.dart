  ...
  void initState() {
    ...
    _adapterStateSubscription = FlutterBluePlus.adapterState.listen((state) {
      ...
      if (state == BluetoothAdapterState.off) {
        ...
        _dismissBluetoothDialog();
        if (state == BluetoothAdapterState.on && mounted) {
          final cubit = context.read<BluetoothCubit>();
          if (cubit.state is BluetoothInitial || cubit.state is BluetoothError) {
            cubit.scanDevices();
          }
        }
      }
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            'The app requires Bluetooth to scan and connect to your Spice Dispenser machine. Would you like to turn it on?',
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: BlocBuilder<BluetoothCubit, BluetoothState>(
                        builder: (context, state) {
                          ...
                          if (state is BluetoothAutoConnecting) {
                            return Text(
                              state.message,
                              style: const TextStyle(
                                fontSize: 16,
                    ...
                    BlocBuilder<BluetoothCubit, BluetoothState>(
                      builder: (context, state) {
                        final isScanning =
                            state is BluetoothLoading ||
                            state is BluetoothAutoConnecting;
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: isScanning
                                ...
                                : () async {
                                    ...
                                    final uuid = await UuidService.getUuid();
                    ...
                    if (state is BluetoothLoaded) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isFavorite = StorageService.getFavoriteDeviceId() == device.id;

                          return DeviceCard(
                            device: device,
                            isFavorite: isFavorite,
                            onFavoriteTap: () {
                              context.read<BluetoothCubit>().setFavoriteDevice(device.id);
                            },
                            onTap: () {
